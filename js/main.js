...
$(document).ready(function () {
  $(".section01 .slide-nav li:first-child").addClass("on");
  var slideNavLeng = $(".section01 .slide-nav li").length;
  var slideW = parseInt($(".section01 .slide-nav ul").width());
  // console.log(slideNavLeng);
  // console.log(slideW);
  ...
  var slideNav = $(".section01 .slide-nav li");
