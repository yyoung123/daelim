...
!(function (e, t) {
  ...
  var I = {
    ...
    slideToLoop: function (e, t, s, a) {
      ...
      return (
        i.params.loop &&
          (i.virtual && i.params.virtual.enabled ? (r += i.virtual.slidesBefore) : (r = i.getSlideIndex(i.slides.filter((e) => 1 * e.getAttribute("data-swiper-slide-index") === r)[0]))),
        i.slideTo(r, t, s, a)
      );
    },
          ...
          if (
            ...
            i.forEach((e) => {
              ...
              t === a && e.classList.add(s.bulletActiveClass),
                s.dynamicBullets && (t >= o && t <= d && e.classList.add(`${s.bulletActiveClass}-main`), t === o && c(e, "prev"), t === d && c(e, "next"));
            });
          else {
            const e = i[a];
